...
and stylist snowboards to suit their riding needs.
...
Ensured thet my code was correct and re added everything to my repositoy. I ensured that I always hard rebooted/refreshed the previewed site to delete the cashed data.
This essential worked, after reading over django documentation and using code forums for extra help. However, I am still unsire as to why it didnt work before, which is something that I am going to look into further.
