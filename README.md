...
- Thanks to Scott Kipp for allowing me to take information from your previous MS4 and providing me with inspiration for the categories 
to products, products to product design for the site.
- The `accounts app` was taken from a previous project that we were taught and had been incorporated into this project, 
to allow me to spend more time on more important aspects of the site which I seemed to struggle with ie. products models.
